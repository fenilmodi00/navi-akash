...
describe('Plugin Models', () => {
  it('should have models defined or be undefined for simplified plugins', () => {
    // For simplified plugins, models may not be defined
    if (plugin.models) {
      expect(typeof plugin.models).toBe('object');
    } else {
      // If models is undefined, that's acceptable for simplified plugins
